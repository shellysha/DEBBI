...
(lib.debiTHEbee222 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		function init() {
			...
			createjs.Sound.registerSound("https://shellysha.github.io/DEBBI/debbi/sounds/CorrectAnswer.mp3", "Correct");
			createjs.Sound.registerSound("https://shellysha.github.io/DEBBI/debbi/sounds/WrongAnswer.mp3", "Wrong");
			createjs.Sound.registerSound("https://shellysha.github.io/DEBBI/debbi/sounds/TimesUp.mp3", "Timesup");
		}
		//--------------------------------------------------------------------
		START();
		function START() {
